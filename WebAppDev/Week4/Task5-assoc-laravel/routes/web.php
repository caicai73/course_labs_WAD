...
Route::get('/', function() 
{
  ...
  // return View::make('views/search_form');
});
...
Route::post('search', function()
{
  ...
  // return view('search_results')->with('name', $name)->with('year', $year)->with('state', $state);
  return view('search_results')->with('pms', $pms)->with('name', $name)->with('year', $year)->with('state', $state);
});
